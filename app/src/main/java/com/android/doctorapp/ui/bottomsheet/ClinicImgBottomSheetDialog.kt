...
import com.android.doctorapp.databinding.FragmentClinicImgBottomSheetDialogBinding
...
class ClinicImgBottomSheetDialog(listener: DialogListener) :
    BaseBottomSheetDialogFragment<FragmentClinicImgBottomSheetDialogBinding>(R.layout.fragment_clinic_img_bottom_sheet_dialog) {
    @Inject
    ...
    override fun onCreateView(
        ...
        val bindingView = binding {
            viewModel = this@ClinicImgBottomSheetDialog.viewModel
